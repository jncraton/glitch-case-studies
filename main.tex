...
This glitch study provides numerous opportunities for learning. A real interactive example like this is multifaceted and can be explored in real time. There are several issues that work together to allow the final issue, showing the importance of defense in depth. The instructor can pose a number of guiding questions as this point:
...
\begin{itemize}
    ...
    \item In Python, what exceptions would you expect if code attempted to use an unexpected value (e.g., indexing with an out-of-range or wrong-type value), and how would catching them prevent crashes or corrupted state?
\end{itemize}
